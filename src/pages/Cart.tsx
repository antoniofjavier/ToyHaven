...
export const Cart = () => {
  ...
  if (cart.length === 0) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-32 text-center">
        ...
        <h1 className="text-4xl font-display font-black text-ink mb-4">Your cart is empty</h1>
        <p className="text-ink/60 mb-10 text-lg">Looks like you haven't added any toys yet.</p>
        <Link
          to="/shop"
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-24">
      <h1 className="text-5xl font-display font-black text-ink mb-12">Your Shopping Bag</h1>
      ...
      <div className="grid lg:grid-cols-3 gap-16 items-start">
            ...
            {cart.map((item) => (
              ...
              >
                ...
                <div className="flex-1 text-center sm:text-left">
                  ...
                  <p className="text-sm text-ink/40 font-semibold mb-4">{item.category} • {item.ageRange} Years</p>
                ...
                <div className="text-right">
                  ...
                  <span className="block text-xs font-bold text-ink/40 mt-1">${item.price} each</span>
                </div>
              </motion.div>
            ))}
          </AnimatePresence>
        ...
        <aside className="space-y-8">
          <div className="bg-ink text-white rounded-[50px] p-10 space-y-8 sticky top-32">
            <h2 className="text-3xl font-display font-bold">Order Summary</h2>
          ...
          <div className="bg-accent/20 rounded-[40px] p-8 text-center">
            <p className="text-ink font-bold mb-2">Need help with your order?</p>
            <p className="text-ink/60 text-sm mb-4">Our friendly team is here to help you find the perfect gift.</p>
            <Link to="/contact" className="text-primary font-black hover:underline">Chat with us</Link>
          </div>
        </aside>
      </div>
    </div>
